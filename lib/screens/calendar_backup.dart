...
look quite confusing in comparison to calendar.dart. Feel free
to ignore it while developing calendar.dart if you don't need 
any extra functionality.
To try this one out, in the main dart change the import 
statement like so:

from
import 'package:by_cycle/screens/calendar.dart';
to
import 'package:by_cycle/screens/calendar_backup.dart';

the button for Calendar in main.dart should look like this
(it doesn't actually take any argument for initial DateTimeRanges):
